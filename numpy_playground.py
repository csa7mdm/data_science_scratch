...
if True:
    print 'array indexing and slicing in action'
    array = np.array([1, 4, 5, 8], float)
    print array
    print ""
    print array[1]
...
if True:
    print 'Matrix indexing and slicing in action'
...
if True:
    ...
    print 'Array arithmetics in action'
...
if True:
    print 'Matrix arithmetics in action'
